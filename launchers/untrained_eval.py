...
MODELS = [
    # {"base_model": "Qwen/Qwen2.5-7B-Instruct", "quantization": "None", "run_name": "Qwen2.5-7B", "gpus": 1},
    # {"base_model": "Qwen/Qwen2.5-7B-Instruct-AWQ", "quantization": "awq", "run_name": "Qwen2.5-7B_AWQ", "gpus": 1},
    # {"base_model": "Qwen/Qwen2.5-14B-Instruct-AWQ", "quantization": "awq", "run_name": "Qwen2.5-14B_AWQ", "gpus": 1},
    # {"base_model": "Qwen/Qwen2.5-32B-Instruct-AWQ", "quantization": "awq", "run_name": "Qwen2.5-32B_AWQ", "gpus": 2},
    {"base_model": "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B", "quantization": "None", "run_name": "Qwen2.5-7B-R1-Distill", "gpus": 2},
]
...
def main():
    for model, temperature, dataset in tqdm(product(MODELS, TEMPERATURES, TEST_DATASETS)):
        ...
        output_file = f"out/eval/untrained/{model['run_name']}_{data_path_safe}{data_name_str}_{dataset['data_split']}_{temperature['temperature']}.json"
